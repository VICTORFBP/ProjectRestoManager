...
// Componente para determinar el dashboard correcto
function DashboardSelector() {
    const { user } = useAuth();

    if (user?.role?.name === "Mesero") {
        return <OrderList />; // O crea un DashboardMesero específico
    }
        ...
        <BrowserRouter>
            <AuthProvider>
                <Routes>
                    ...
                    >
                        {/* DASHBOARD - Admin y Mesero (pero diferente contenido) */}
                        <Route
                            path="/"
                            element={
                                <ProtectedRoute
                        ...
                        {/* TABLES - Admin y Mesero (solo ver) */}
                        <Route
                            path="/tables"
                            element={
                                <ProtectedRoute
